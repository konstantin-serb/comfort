<html lang="ua">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="article-styles.css">
        <link rel="stylesheet" type="text/css" href="company-styles.css">
        <link rel="stylesheet" type="text/css" href="designers-styles.css">
        <link rel="stylesheet" type="text/css" href="news-styles.css">
        ...
        <link rel="stylesheet" type="text/css" href="service-styles.css">
        <link rel="stylesheet" type="text/css" href="techinfo-styles.css">
        <link rel="stylesheet" type="text/css" href="catalog-styles.css">
        <link rel="stylesheet" type="text/css" href="catalog-cart-styles.css">
    ...
    <body>
        ...
        <section class="article">
            <div class="block">
                <div>
                    <a href="news.html">Новини&nbsp;&nbsp;></a> &nbsp;&nbsp;Переваги електричної теплої підлоги
                </div>
                <h1>Переваги електричної теплої підлоги</h1>
                <img src="images/img3.svg" alt="">
                <p>У сучасному світі для кожного технічного завдання є як мінімум кілька різних варіантів його реалізації. Електричні кабельні нагрівальні системи - це один з інструментів вирішення питання комфортного підігріву поверхні підлоги. Ми склали для вас список переваг, які, можливо, допоможуть вам обрати електричну теплу підлогу в якості вирішення вашого завдання.</p>
                <h3>Унікальний комфорт</h3>
                <p>Ходити босоніж по теплій підлозі це невимовне задоволення. Вам потрібно лише встановити на регуляторі температуру, яка підходить саме вам і насолоджуватися приємним теплом, назавжди забувши про килими і домашнє взуття.</p>
                <h3>Додаткове джерело тепла</h3>
                <p>Підігрів поверхні підлоги до комфортної температури також нагріває повітря в приміщенні, завдяки чому знижуються витрати на основне опалення.</p>
                <p>Пример списка в тексте:</p>
                <ul>
                    <li>Теплый пол</li>
                    <li>Полное отопление помещений</li>
                    <li>Снеготаяние</li>
                    <li>Защита от льда</li>
                    <li>Защита труб от замерзания</li>
                    <li>Технологический подогрев резервуаров</li>
                    <li>Промышленный обогрев</li>
                </ul>
            </div>
        </section>
