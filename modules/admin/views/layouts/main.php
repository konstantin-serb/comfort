        ...
        'items' => [
            ...
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Сервіс і обслуговування', 'url' => ['/admin/site-service/view', 'id'=> 1]],
                    ['label' => 'Технічна інформація', 'url' => ['/admin/site-tech/view', 'id'=>1]],
                    ['label' => 'Новости', 'url' => ['/admin/site-news/view', 'id'=>1]],
                    ['label' => 'Дизайнерам і архітекторам', 'url' => ['/admin/site-designers/view', 'id'=>1]],
                    ['label' => 'Компанія', 'url' => ['/admin/site-company/view','id'=>1]],
                    ['label' => 'Тест', 'url' => ['/admin/site-test/view','id'=>1]],
                    ['label' => 'Співробітництво', 'url' => ['/admin/site-colaborate/view','id'=>1]],
                ],
